...
public class OutputDocument {
	...
	static public class HeaderFooterPageEvent extends PdfPageEventHelper {
	    ...
	    public void onEndPage(PdfWriter writer,Document document) {
	        ...
	        ColumnText.showTextAligned(writer.getDirectContent(),Element.ALIGN_CENTER, new Phrase(new Phrase(Character.toUpperCase(letter) + "/" + String.format("%d", writer.getCurrentPageNumber()))), rect.getRight(), rect.getBottom(), 0);
	    }
	} 
	...
	public static void createDocument(QBase qb) throws DocumentException,
		...
		// step 2
		PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream("test"+Character.toUpperCase(qb.getLetterOfSet())+".pdf"));
