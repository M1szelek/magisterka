...
public class OutputDocument {
	...
	public static void createDocument(QBase qb) throws DocumentException,
		...
		// step 2
		PdfWriter.getInstance(document, new FileOutputStream("test"+qb.getSetLetter()+".pdf"));
		// step 3
		document.open();
		// step 4
		...
		Paragraph title = new Paragraph("Egzamin in¿ynierski - zestaw "+qb.getSetLetter(), font);
	...
	public static void createCalque(QBase qb) throws DocumentException,
		...
		Document document = new Document();
		// step 2
		PdfWriter.getInstance(document, new FileOutputStream("kalka"+qb.getSetLetter()+".pdf"));
		// step 3
		document.open();
	...
	public static void createCalque2(QBase qb) throws DocumentException,
		...
		PdfWriter writer = PdfWriter.getInstance(document,
				new FileOutputStream("kalka"+qb.getSetLetter()+".pdf"));
		// step 3
		document.open();
	...
	static public float addHeaderTable(Document document, QBase qb)
	        ...
	        Phrase p = new Phrase("Zestaw "+qb.getSetLetter(), font);
